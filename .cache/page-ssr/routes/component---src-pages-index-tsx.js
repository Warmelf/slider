...
//
const HomeLazy = react_loadable__WEBPACK_IMPORTED_MODULE_1___default()({
  loader: () => __webpack_require__.e(/*! import() */ "src_containers_Home_jsx").then(__webpack_require__.bind(__webpack_require__, /*! ../containers/Home */ "./src/containers/Home.jsx")),
  loading: loader
});
const Index = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(HomeLazy, null));
};
